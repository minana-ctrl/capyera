          ...
          <TabsContent value="inventory" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Stock levels, movements, and forecasts
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Inventory reporting features coming soon
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="sales" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revenue trends, order analysis, and customer insights
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Sales reporting features coming soon
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="financial" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Profit margins, expenses, and financial forecasts
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
